...
class OAuthController extends Controller
{
    ...
    public function auth(Request $request)
    {
        ...
        if ($type === 'google') {
            ...
            $googleCallbackUri = url('/lufei/passport/oauth/google/callback');
            ...
            $telegramUrl = url('/lufei/passport/oauth/telegram');
            if (!empty($code)) {
            ...
            try {
                ...
                $tokenResponse = $httpClient->post('https://oauth2.googleapis.com/token', [
                    'form_params' => [
                        ...
                        'redirect_uri' => url('/lufei/passport/oauth/google/callback'),
                    ]
                ]);
