            ...
            <table width="100%" cellpadding="0" cellspacing="0">
              <tr>
                <td align="center" style="font-size: 15px; color: #c2c9d6; line-height: 1.7; padding-bottom: 25px;">
                  我们检测到新的登录请求，请点击下方按钮完成验证。<br>若此邮件被拦截或在垃圾箱中，请将发信邮箱加入联系人或白名单。
                </td>
              </tr>
            </table>
        ...
        <tr>
          <td style="padding: 15px; background-color: rgba(255,255,255,0.05); text-align: center;">
            <p style="margin: 0; font-size: 12px; color: #8792a2;">
              🔒 安全邮件提醒 · {{$name}} · <a href="https://sway.cloud.microsoft/MG3JKNnxAVuuQAnZ?ref=Link" target="_blank" style="color: #00e5ff; text-decoration: none;">如失联请点击这里</a>
            </p>
          </td>
        </tr>
      </table>
