                ...
                <td>
                    ...
                    <div style="padding: 40px; color: #c2c9d6;">
                        ...
                        <div style="margin-top: 30px; text-align: center;">
                            ...
                            <p style="margin-top: 20px; font-size: 15px; line-height: 1.7; text-align: center;">
                            若此邮件被拦截或在垃圾箱中，请将发信邮箱加入联系人或白名单。
                        </p>
                        </div>
                    </div>
                    ...
                    <div style="padding: 15px; background-color: rgba(255, 255, 255, 0.05); text-align: center;">
                        <p style="margin: 0; font-size: 12px; color: #8792a2;">
                            🔒 这是来自 {{$name}} 的重要通知  · <a href="https://sway.cloud.microsoft/MG3JKNnxAVuuQAnZ?ref=Link" target="_blank" style="color: #00e5ff; text-decoration: none;">如失联请点击这里</a>
                        </p>
                    </div>
                </td>
            </tr>
